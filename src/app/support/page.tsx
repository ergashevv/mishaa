      ...
      <main className="container mx-auto px-8 pt-48 pb-32">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className=" p-10 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl flex flex-col items-center text-center space-y-6">
            ...
            <div className=" p-10 bg-[#0a0a0a] border border-white/10 rounded-3xl flex flex-col items-center text-center space-y-6">
          ...
          <div className=" p-16 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl relative overflow-hidden">
            ...
            <div className="space-y-8 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
                <div className="space-y-4">
                  ...
                  <input type="text" className="w-full bg-transparent border border-white/20 rounded-xl px-6 text-white py-4 text-xs font-bold focus:outline-none" placeholder="IDENTIFY_YOURSELF" />
                </div>
                <div className="space-y-4">
                  <label className="text-[10px] font-black uppercase tracking-widest opacity-40">Category</label>
                  <select className="w-full bg-transparent border border-white/20 rounded-xl px-6 text-white py-4 text-xs font-bold focus:outline-none appearance-none">
                ...
                <div className="md:col-span-2 space-y-4">
                  ...
                  <textarea className="w-full bg-transparent border border-white/20 rounded-xl px-6 text-white py-4 text-xs font-bold focus:outline-none min-h-[200px]" placeholder="WHAT_HAPPENED_DURING_PRODUCTION?" />
                </div>
              </div>
              <button className="px-8 py-4 uppercase font-black tracking-widest transition-all rounded-lg w-full sm:w-auto px-16 py-6 bg-black text-white">
                Submit Report
              </button>
            </div>
          </div>
